...
get_diffu2000_biopsy_withheader_newgli=function(bnum_tnum_df, measure, headerlabel){
  data=data.frame()
...
get_diffu2000_biopsy_noheader_newgli=function(bnum_tnum_df, measure){
  data=data.frame()
  for(i in 1:dim(bnum_tnum_df)[1]){
...
#######################################################################################################################################
get_ev2000_biopsy_noheader_newgli=function(bnum_tnum_df, measure){
  data=data.frame()
  for(i in 1:dim(bnum_tnum_df)[1]){
    y=paste("/data/NEWglioma/", bnum_tnum_df$bnum[i], "/", bnum_tnum_df$tnum[i], sep="")
    tnum_files = list.files(y)
...
#######################################################################################################################################
#######################################################################################################################################
get_ev2000_biopsy_withheader_newgli=function(bnum_tnum_df, measure, headerlabel){
  data=data.frame()
  for(i in 1:dim(bnum_tnum_df)[1]){
    y=paste("/data/NEWglioma/", bnum_tnum_df$bnum[i], "/", bnum_tnum_df$tnum[i], sep="")
    tnum_files = list.files(y)
...
get_diffu2000_biopsy_newgli = function(bnum_tnum_df, measure, headerlabel=NULL, datatype=NULL){
  ...
  if(is.na(headerlabel) && !is.na(datatype)){
    if(datatype == "adcfa"){
      get_diffu2000_biopsy_noheader_newgli(bnum_tnum_df, measure)
    }
    else{
      get_ev2000_biopsy_noheader_newgli(bnum_tnum_df, measure)
    }
  }
  ...
  ## want only specific headerlabel for adcfa
    ...
    get_diffu2000_biopsy_withheader_newgli(bnum_tnum_df, measure, headerlabel)
  }
  ## want all the adcfa and all of the ev data 
  else if (is.na(headerlabel) && is.na(datatype)){
    data_adcfa = get_diffu2000_biopsy_noheader_newgli(bnum_tnum_df, measure)
    data_ev = get_ev2000_biopsy_noheader_newgli(bnum_tnum_df, measure) 
