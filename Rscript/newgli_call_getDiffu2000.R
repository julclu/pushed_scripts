...
source("/home/sf673542/pushed_scripts/Rscript/get_diffu2000_biopsy_newgli.R")

bnum_tnum_df = read.csv(args[1], header=F)
colnames(bnum_tnum_df)=c("bnum", "tnum", "DUMMY")
data = get_diffu2000_biopsy_newgli(bnum_tnum_df, measure= args[3], headerlabel=args[4], datatype=args[5])
